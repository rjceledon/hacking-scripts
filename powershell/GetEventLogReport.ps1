#Pulled from https://github.com/IBM/wincollect and edited by rjceledon to ignore Forms and just export local events to C:\Temp
...
function Export-LogReport { param($Computerlist, $ComputerCount, $ComputerListType)    
    ...
    try {
        ...
        New-Item -Force –Itemtype Directory –Path "C:\Temp"

        $ExportLocation = "C:\Temp\Event-Log-Summary-Report-" + $(get-date -f yyyyMMddhhmmss) + ".csv"            
...
$ComputerListType = $LOCALHOST_OPT
